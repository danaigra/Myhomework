...
public class homework6_2 extends View{
    ...
    public homework6_2(Context context) {
        super(context);
        init();
    }

    public homework6_2(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public homework6_2(Context context, AttributeSet attrs, int defStyleAttr) {
